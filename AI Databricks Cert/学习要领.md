...
**Databricks GenAI Engineer Associate 主要考你是否能在 Databricks 上，完成从 Prompt 设计、RAG 数据准备、链路开发，到向量检索、模型注册、服务部署和治理监控的完整落地流程。**

再压缩一点就是：

**会设计、会清洗、会切块、会检索、会组链、会部署、会评估、会治理。**

---

如果你愿意，我下一步可以继续把这份内容整理成更适合背诵的 **“考试重点版”**，或者直接帮你做成 **中英对照术语表**。